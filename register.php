...
-->
                            ...
                            <div class="panel-body">
                                ...
                                <form action="Registration_Verfi.php" accept="multipart-formdata" method="post"
                                    ...
                                    <div class="row" style="margin-left: auto; margin-right: auto;">
                                        <div class="col-md-12">
                                            ...
                                            <input style="float:right;" value="Sign Up" type="button"
                                                onclick="topFunction()" id="Reg_form" name="signup_button"
