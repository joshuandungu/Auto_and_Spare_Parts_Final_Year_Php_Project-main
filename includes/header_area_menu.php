                         ...
                         <div class="header_top_links text-right">
                             <ul>
                                 <?php if (!isset($_SESSION['name'])) {
                                    ?>
                                     <li><a href="./customer/customer_login.php">Buy</a></li>
                                     <li><a href="./seller/seller_login.php">Sell</a></li>';
                                 <?php } ?>
                                 <?php if (isset($_SESSION['name'])) {
                                    ?>
                         ...
                         <div class="header_right_box">
                             ...
                             <div class="header_configure_area">
                                 <div class="header_wishlist">
                                     <a href="./customer/wishlist_profile.php"><i class="icon-heart"></i>
                                 ...
                                 <ul>
                                     ...
                                     <?PHP
                                        ...
                                        ?>
                                         ...
                                         <li><a href="./products.php?category=<?php echo $cat_title; ?>">
                                     ...
                                     <li><a href="all_product_sh.php"> <?php // echo $cat_title; 
                                                                        ?> </a></li>
