                    ...
                    <div class="tab-pane fade show active" id="Sellers" role="tabpanel">
                        <div class="row">
                            <div class="product_carousel product_column5 owl-carousel">
                                ...
                                $idct = $_GET['id'];
                                $product_query2 = "SELECT * FROM products where  product_cat = '$idct' ";
                                    ...
                                    <article class="single_product">
                                        <figure>
                                            <div class="product_thumb">
                                                <a class="primary_img"
                                                    href="product_details_v_profile.php?idp01=<?php echo $pro_id; ?>">
                                                    <img src='login/Image_Product/<?php echo $pro_image ?>' /></a>
                                            ...
                                            <div class="product_content">
                                                <div class="product_content_inner">
                                                    ...
                                                    <h4 class="product_name"><a
                                                            href="product_details_v_profile.php?idp01=<?php echo $pro_id; ?>"><?php echo $pro_title; ?></a>
                                                    </h4>
        ...
        <div class="product_carousel product_details_column5 owl-carousel">
            ...
            <div class="col-lg-3">
                <article class="single_product">
                    <figure>
                        <div class="product_thumb">
                            <a class="primary_img" href="product_details_v_profile.php?idp01=<?php echo $pro_id; ?>">
                                <img src='login/Image_Product/<?php echo $pro_image ?>' /></a>
                            <div class="label_product">
                                <span class="label_sale">-52%</span>
                            </div>
                            <div class="quick_button">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal_box" title="quick view"><i
                                        class="icon-eye"></i></a>
                            </div>
                        </div>
                        <div class="product_content">
                            ...
                            <div class="action_links">
                                <ul>
                                    <li>
                                        <button pid="<?php echo $pro_id; ?>" id="product" class="btn btn-primary">Add To
                                            Cart </button>
                                        <!--
                                             <button pid="<?php echo $pro_id; ?>"  id="product" class="btn btn-primary">Add To Cart </button></li>
