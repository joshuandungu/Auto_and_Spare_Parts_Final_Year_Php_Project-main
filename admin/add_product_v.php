...
if (!empty($image['name'])) {
  ...
  if (move_uploaded_file($tmp, $target_path)) {
    ...
    $product_id = mt_rand(1000000, 9999999);
    $sql = "INSERT INTO `products`(`product_id` ,`vendor_id`, `vendor_name`,  `product_cat`, `product_brand`, `product_title`, `product_price`, `product_qty`, `product_desc`, `product_image`, `product_keywords`, `gas_weight`) VALUES ( '$product_id', '$vendor_id', '$vendor_name',  '$category', '$brand_name', '$product_name', '$price', '$qty', '$desc', '$newimage', '$keyw', '$gas_weight')";
