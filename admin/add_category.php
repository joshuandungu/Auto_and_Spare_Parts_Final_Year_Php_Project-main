                    ...
                    <div class="card-body">
                        <div class="row">
                            <ul>
                                ...
                                <li>
                                    <eg href="category.php">Category</a>
                                </li>
                            </ul>


                        </div>
                        <h2 style="text-align: center; font-weight: bold;">Add Category</h2>
                        ...
                        <form action="add_category.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="pro_cat" id="cat" class="form-control" />
                                </div>
                                <br />
                                <div class="col-md-12">
                                    <button style="float: right;" type="submit" name="add_cat" value="submit]"
