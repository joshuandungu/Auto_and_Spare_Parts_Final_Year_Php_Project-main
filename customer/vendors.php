                            ...
                            <article class="single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a class="primary_img"
                                            href="vendor_details_v.php?vendor_id=<?php echo $row['vendor_id']; ?>">
                                    ...
                                    <div class="product_content">
                                        <div class="product_content_inner">
                                            <p class="manufacture_product"><a
                                                    href="vendor_details_v.php?vendor_id=<?php echo $row['vendor_id']; ?>">View
                                                    More</a>
                                            </p>
                                            <h4 class="product_name"><a
                                                    href="vendor_details_v.php?vendor_id=<?php echo $row['vendor_id']; ?>"><?php echo $row['vendor_name']; ?></a>
                                            </h4>
