            ...
            <div class="col-md-8">
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <h6>Information Order Sendding</h6>
                    </div>
                    <div class="panel-body">
                            ...
                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="f_name" name="f_name"
                                            value="<?PHP echo $_view['first_name'] ?>" class="form-control" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="f_name">Last Name</label>
                                        <input type="text" id="l_name" name="l_name"
                                            value="<?PHP echo $_view['last_name'] ?>" class="form-control">
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="email" name="email" class="form-control"
                                            value="<?PHP echo $_view['email'] ?>" readonly>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="mobile" name="mobile" class="form-control"
                                            value="<?PHP echo $_view['mobile'] ?>" required>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="address1" name="address1"
                                            value="<?PHP echo $_view['address1'] ?>" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="address2" name="address2"
                                            value="<?PHP echo $_view['address2'] ?>" class="form-control">
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="card_H_N" name="card_H_N" class="form-control"
                                ...
                                <div class="row" style="margin-left: auto; margin-right: auto;">
                                    <div class="col-md-12">
                                        <input value="Confirm" type="button" onclick="topFunction()"
                                            id="customer_information_order" name="signup_button"
