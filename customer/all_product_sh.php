                                            ...
                                            <article class="single_product">
                                                <figure>
                                                    <div class="product_thumb">
                                                        <a class="primary_img"
                                                            href="product_details_v.php?idp01=<?php echo $pro_id; ?>"> <img
                                                                src='login/Image_Product/<?php echo $pro_image ?>' /></a>
                                                    ...
                                                    <div class="product_content">
                                                        <div class="product_content_inner">
                                                            <p class="manufacture_product"><a
                                                                    href="product_details_v.php?idp01=<?php echo $pro_id; ?>">Parts
                                                                    of <?php echo $pro_brand; ?></a></p>
                        ...
                        ?>
                                ...
                                <div class="col-lg-3">
                                    <article class="single_product">
                                        <figure>
                                            <div class="product_thumb">
                                                <a class="primary_img" href="product_details_v.php?idp01=<?php echo $pro_id; ?>">
                                            ...
                                            <div class="product_content">
                                                <div class="product_content_inner">
                                                    <p class="manufacture_product"><a
                                                            href="product_details_v.php?idp01=<?php echo $pro_id; ?>">Parts</a>
                                                    </p>
                                                    <h4 class="product_name"><a
                                                            href="product_details_v.php?idp01=<?php echo $pro_id; ?>"><?php echo $pro_title; ?></a>
                                                    </h4>
