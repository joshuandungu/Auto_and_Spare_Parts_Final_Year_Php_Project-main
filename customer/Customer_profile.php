                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="slider_content">
                                <h1>Big sale off <span>Gas Accessories</span></h1>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="slider_content center">
                                <h1>Gas Cyliners <span>all kinds </span></h1>
                                <p>Exclusive Offer -30% Off This Week</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single_slider d-flex align-items-center" data-bgimg="assets/img/slider/slider3.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="slider_content">
                                <h1>High-end <span>Gas Products Delivery Dine Country wde</span> </h1>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="welcome_title">
                        <h3>WELCOME TO KOSYIN GAS SUPPLERS</h3>
