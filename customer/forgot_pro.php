	...
	<div class="container-fluid ">
		<div class="row justify-content-center">
			...
			<div class="col-md-4">
				...
				<h1>
					<center><b>Forgotten Password</b></center>
				</h1>
				<hr>
				...
				<form method="post" onsubmit="return false">
					...
					?>
						<div class="row">
							<div class="col-md-12">
								...
								<input type="text" id="email" name="email" value="<?php echo $_view['email']; ?>"
					...
					<div class="row">
						<div class="col-md-12">
							...
							<input type="text" id="cnic" name="cnic" class="form-control" placeholder="Enter CNIC NO"
								required>
						</div>
					</div>
					<br>
					...
					<div class="row" style="float:right">
						<div class="col-md-12">
							<input value="submit" type="button" id="forgott2" name="Submit"
