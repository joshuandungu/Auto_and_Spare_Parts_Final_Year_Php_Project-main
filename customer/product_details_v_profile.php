                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="product-details-tab">
                            <div id="img-1" class="zoomWrapper single-zoom">
                                <a href="#">
                                    <img id="zoom1" src="../seller/images/products/<?php echo $pro_image ?>"
                                        data-zoom-image="../seller/imagesproducts/<?php echo $pro_image ?>" alt="big-1">
                                </a>
                            </div>
...
-->
                                <?php if ($status ==  '1') {
                                ?>
                                <button pid="<?php echo $pro_id; ?>" id="product" class="btn btn-primary"
                                    name="addToCart">Add To Cart
                                </button>
                                <?php } else { ?>
                            ...
                            <div class=" product_d_action">
                                <ul>
                                    ...
                                    <li><a class="wishlist" href="#" title="Add to wishlist"
                                            pid="<?php echo $pro_id; ?>" id="product_wishlist">+ Add to Wishlist</a>
                                    </li>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tbody id="product_list">
                        ...
                        $query1 = mysqli_query($con, "SELECT * FROM product_reviews WHERE product_id
= '$pro_id' ");
                        $cnt = 1;
                ...
                <form action="includes/comment_class.php" method="post">
                    ...
                    <input type="hidden " name="product_id" value=<?php echo $pro_id;  ?> hidden>
                    <textarea type="text" style="width: 300px;" id="comment" class="form-control"
                        name="comment"></textarea>
                    <button type="submit" class="btn btn-success" value="submit" aria-placeholder="Add Comment">Ad
                        Comment</button>
                </form>
            </div>
