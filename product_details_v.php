...
<body>
    ...
    <div class="product_page_bg">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="product_d_right">
                            <form action="#">
                                ...
                                <h3>Vendor:<b><a
                                            href="vendor_details_v.php?idp01=<?php echo $row['vendor_id']; ?>"><?php echo $row['vendor_name']; ?></a></b>
                                </h3>
                                ...
                                <?php if ($row['status'] == '1') {
                                        ?>
                                <button id="product" class="btn btn-primary">
                                    <a href="action.php?proId=<?php echo $row['product_id']; ?>">Add To
                                        Cart
                                    </a>
                                </button>

                                <li><a class="wishlist"
                                        href="customer/wishlist_add.php?proid=<?php echo $row['product_id']; ?>"
        ...
        <div class="table-responsive">
            ...
            <form action="customer/customer_login.php" method="post">
